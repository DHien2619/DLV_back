    ...
    return (
        <div className="dashboard-container">
            ...
            <aside className={`left-sidebar ${sidebarOpen ? '' : 'collapsed'} ${mobileSidebarOpen ? 'mobile-open' : ''}`}>
                ...
                {user?.role === 'admin' && (
                    <button className="new-chat-btn" onClick={() => window.location.href = '/dashboard'}
                        style={{ background: 'rgba(129,140,248,0.1)', borderColor: 'rgba(129,140,248,0.25)', color: '#818cf8', marginTop: '4px' }}>
